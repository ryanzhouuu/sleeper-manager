...
from tests.sleeper_manager.backtesting.experiments.input_index_support import sample_index
...
def test_separate_league_manifests_form_one_inventory(tmp_path: Path) -> None:
    ...
    from ..replay.inputs.historical_team_week_artifact_support import _manifest, _team_week
