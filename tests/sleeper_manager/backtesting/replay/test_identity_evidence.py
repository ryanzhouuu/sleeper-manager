...
def test_bundle_uses_recovered_id_without_current_roster_team(tmp_path: Path) -> None:
    ...
    from tests.sleeper_manager.backtesting.replay.team_week_projection_support import _nba_inputs
    from tests.sleeper_manager.backtesting.replay.team_week_source_support import (
        LEAGUE_ID,
        RETRIEVED_AT,
        _write_archive,
    )
